...
## 1 Fork 代码
1. 访问 https://github.com/ego-component/ek8s
...
```bash
git clone https://github.com/ego-component/ek8s.git
cd ek8s
git remote add upstream 'git@github.com:<your github username>/ek8s.git'
```
...
## 6 提交 PR
访问 https://github.com/ego-component/ek8s, 
